<template>
  <div>
    ...
    >
      ...
      <el-table-column label="Комментарий" column-key="note" :sortable="true" :min-width="300" :max-width="450" :width="450" align="left">
        <template slot-scope="scope">
      ...
      <el-table-column fixed="right" align="center" label="Действия" width="200">
        <template slot-scope="scope">
