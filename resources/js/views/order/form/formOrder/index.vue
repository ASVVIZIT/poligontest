<template>
  <div class="app-container">
    <el-form ref="formOrder" :model="form" label-width="310px" style="padding-right: 50px">
      <el-header style="padding-left: 50px">
        <el-link><h2>Создание заказа ID 00023</h2></el-link>
      </el-header>
      <el-form-item label="Тип заказа">
      ...
      <el-form-item label="Краткое описание заказа">
        <el-input v-model="form.name" />
      </el-form-item>
      <el-form-item label="Дата и время создания заказа">
        <el-col :span="8">
          <el-date-picker v-model="form.date1.selectedDate" type="date" :default-value="form.date1.defaultDate" placeholder="Выбирите дату заказа" style="width: 100%;" />
          <el-tag style="text-align: center">
        ...
        <el-col :span="6">
          <el-time-picker v-model="form.date1time.selectedTime" type="fixed-time" :default-value="form.date1time.defaultTime" placeholder="Выбирите время заказа" style="width: 100%;" />
          <el-tag style="text-align: center">
      ...
      <el-form-item label="Выбор заказчика и исполнителя" width="500px">
        ...
        <el-col :span="8">
          <el-select v-model="form.select_2_id" placeholder="Пожалуйста, выберите исполнителя заказа" style="width: 100%">
      ...
      <el-form-item label="Полное описание заказа">
        <el-input
