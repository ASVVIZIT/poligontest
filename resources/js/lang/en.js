export default {
  route: {
    ...
    dragTableList: 'Drag Table List',
    inlineEditTable: 'Inline Edit',
    complexTable: 'Complex Table',
    treeTable: 'Tree Table',
    customTreeTable: 'Custom TreeTable',
    complexTableMain: 'Custom TreeTable (Dev)',
    tab: 'Tab',
    form: 'Form',
    ...
    i18n: 'I18n',
    externalLink: 'Link (Repo developer)',
    externallink_poligon: 'Link (Repo for tester)',
    ...
    emailsend: 'Отправка E-mail',
    emaillist: 'Список E-mail',
    order: 'Заказ',
    orders: 'Заказы',
    OrdersList: 'Список заказов',
    OrdersListTest: 'Список заказов (тест)',
  ...
  login: {
    ...
    email: 'E-mail',
    lable_Profile: 'Profile admin',
    lable_Email: 'E-mail',
    lable_password: 'Password',
    Switch_message: 'Switch Language Success',
    Switch_type: 'Success',
  },
  documentation: {
    documentation: 'Documentation',
  ...
  theme: {
    ...
    changes: 'Theme successfully selected',
  ...
  roles: {
    description: {
      SuperAdmin: 'Super Administrator. Have access and full permission to all pages. Запасной - права такие же как и у Admin',
      admin: 'Administrator. Have access and full permission to all pages.',
